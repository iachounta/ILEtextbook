...
```{r aiedstory, out.width ="13cm", fig.cap="A timeline of AIED", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r classdistribution, out.width= "13cm", fig.cap="The real population distribution of beavers in the wild nature", echo=FALSE, message=FALSE, warning=FALSE}
knitr::include_graphics("./images/classdistribution.png")
```

```{r classimbalance, out.width= "13cm", fig.cap="The sample population distribution of beavers used for AI training", echo=FALSE, message=FALSE, warning=FALSE}
...
```{r beavershidden, out.width= "13cm", fig.cap="The sample population distribution of beavers marked with the hidden feature", echo=FALSE, message=FALSE, warning=FALSE}
