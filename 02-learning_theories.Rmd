...
```{r multistoremodel, out.width = "10cm", fig.cap="A simplified representation of human memory according to the Multi-store Model", echo=FALSE, message=FALSE, warning=FALSE}
...
-    "...a category of educational software in which the learner is `put' into a problem solving situation." [@dillenbourg1994intelligent] 

-    "...a learning environment that allows for student-driven learning" [@kay1997learner]
...
"*[intelligent learning environments is] a broad category of digital educational interactive applications equipped with features that enable the provision of personalized, adaptive support to students*" [@mavrikis2019intelligent]
